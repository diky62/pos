    ...
    public function data()
    {
        ...
        return datatables()
            ...
            ->addColumn('aksi', function ($produk) {
                return '
                <div class="group">
                    <button type="button" onclick="editForm(`'. route('produk.update', $produk->id) .'`)" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</button>
                    <button type="button" onclick="deleteData(`'. route('produk.destroy', $produk->id) .'`)" class="btn btn-danger "><i class="fa fa-trash"> Hapus</i></button>
                </div>
                ';
            })
